...
- **La base del umbral —con o sin IVA— sigue SIN resolver, y el DOF no la resuelve.** El Acuerdo no menciona impuestos. Es la pregunta más cara del proyecto y le toca al especialista PLD (issue #3).
