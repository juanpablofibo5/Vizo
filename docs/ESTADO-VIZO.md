...
| 21 | Screening de listas (OFAC · ONU · LPB · 69-B · PEP) | ◐ **Conector construido (29-ago, ADR-30):** listas versionadas con hash, matching por trigramas + RFC exacto, consulta con snapshot que nace pendiente, resolución humana única con razonamiento, alerta que nombra su consulta. **Pendiente:** parsers ONU/LPB (vía provisional en runbook 06), alias de OFAC, y la **primera carga real de las cuatro listas** — sin ella la consulta se detiene a propósito. PEP sigue como dependencia comercial aparte, no se vende | ADR-30 · migración `20260829230000` · runbook 06 · `tests/.../screening.test.ts` |
