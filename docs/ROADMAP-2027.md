...
**La Fase 3 quedó construida el 6-sep-2026 (ADR-41), y con ella EL PLANO COMPLETO:** el evento estructural dispara sus cuatro efectos en una transacción —cierre de vigencias señaladas, cola de reevaluación, plazo operativo congelado y alerta que nombra al evento—, la siguiente identificación atiende lo pendiente (solo lo ya ocurrido), y el riel envejece con honestidad: «Estructura cambió», no «vencida».

**Lo que sigue sin cubrir:** las nueve preguntas de `docs/BENEFICIARIO-CONTROLADOR.md` §6 al especialista, más POR CONFIRMAR-14 — entre ellas si la actualización «durante la vigencia de la Relación de negocios» corre con la revisión anual del Art. 21 o tiene disparador propio.
...
**La Fase 1 quedó construida el 8-sep-2026 (ADR-43): el periodo, la ruta y el auditor.** El obligado abre el periodo de un año y VIZO calcula sus fechas —ordinario del Art. 42, o el largo del primer año de operaciones del Art. 43—, hereda la ruta de la evaluación de entidad vigente y la **congela con ella**: si el grado cambia después, el periodo no se reescribe, dice sobre qué evaluación se fijó y si hoy daría otra cosa (ADR-25 otra vez). Lo que hace valioso el capítulo es que el Art. 44 **se verifica, no se declara**: que el auditor interno no sea el REC y que tenga al menos una constancia de capacitación son hechos que VIZO comprueba contra la plantilla y las asistencias del Cap. XII — la primera vez que un capítulo usa a otro como requisito verificable. La ruta externa obligatoria del Art. 45 cierra la puerta al auditor interno desde la base, no solo desde la aplicación. Del Art. 50 se calcula el reloj de entrega, retrocediendo fines de semana y —cuando el año esté cargado— días inhábiles; sin ese calendario la fecha viaja diciendo que puede caer antes.

**Lo que sigue del capítulo:** Fase 2, el dictamen —sus siete secciones del Art. 47, los cinco resultados por obligación del Art. 48 con sus reglas de coherencia, y el paquete de evidencia por obligación—; Fase 3, los hallazgos con plazo, responsable y proyección de multas del Art. 49, el seguimiento del dictamen anterior, y la conservación de cinco años del Art. 51.
